    ...
    let list = posts.map(({ name, username, location, avatar, post, comment, likes }) => `
        <section>
            <div class="avatar-container">
                <img class="avatar-img" src="${avatar}" alt="Avatar Image">
            ...
            <div>
                <img class="post-img" src="${post}" alt="post-image">
            </div>
            <div class="bottom-info">
                <div class="icons-container">                    
                    <img id="likeIt" class="icon" src="./images/icon-heart.png" alt="Heart Icon">
